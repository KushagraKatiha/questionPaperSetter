                ...
                <div className='flex ml-10 items-end mt-5 gap-10 font-extrabold'>
                    ...
                    <div className='flex flex-col gap-5 h-full'>
                        ...
                        <div className='bg-black p-2 rounded-lg border-2 border-[#9c36b5]'>
                            ...
                            {questionType === 'long' ? (
                                <select className='focus:outline-none h-8 text-white px-1 py-1 bg-black border-[#9c36b5] border-2 rounded-lg' value={questionNumber} onChange={handleQuestionNumber}>
